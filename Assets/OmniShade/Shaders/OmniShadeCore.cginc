...
//////////////////////////////////////////////////////////////////////////////////////////
	...
	struct v2f {
		...
		#endif
		#if NORMAL_MAP && ((DIFFUSE && (!LIGHTMAP_ON || MIXED_LIGHTING)) || RIM || SPECULAR || MATCAP || DIRLIGHTMAP_COMBINED || REFLECTION) \
			|| SPECULAR_HAIR
...
v2f vert (appdata_full v) {
	...
	#if (!TRIPLANAR && \
			NORMAL_MAP && ((DIFFUSE && (!LIGHTMAP_ON || MIXED_LIGHTING)) || RIM || SPECULAR || MATCAP || DIRLIGHTMAP_COMBINED || REFLECTION)) \
		|| SPECULAR_HAIR
